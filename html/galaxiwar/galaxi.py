...
icono = pygame.image.load('galaxiwar\\vader.png')
pygame.display.set_icon(icono)
fondo = pygame.image.load('galaxiwar\\stars.jpg')
#jugador
img_jugador=pygame.image.load('galaxiwar\\obiwan.png')
jugador_x = 368#lo ubicamos en el centro que sería 400 menos la mitad de los 64 pixeles del icono.png
jugador_y = 500
jugador_x_cambio = 0

#agregar musica
mixer.music.load('galaxiwar\\banda.mp3')
...
for e in range(cantidad_de_enemigos):
    #enemigo
    img_enemigo.append(pygame.image.load('galaxiwar\\overdark.png'))
...
#bala
img_bala=pygame.image.load('galaxiwar\\misil2.png')
...
while se_ejecuta:
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.KEYDOWN:
            ...
            if evento.key == pygame.K_SPACE:
                sonido_bala = mixer.Sound("galaxiwar\\sss.mp3")
                sonido_bala.play()
                if not bala_visible:
                    bala_x = jugador_x
    ...
    #mantener dentro de los bordes
        ...
        if colision:
            sonido_colision = mixer.Sound("galaxiwar\\lll.mp3")
